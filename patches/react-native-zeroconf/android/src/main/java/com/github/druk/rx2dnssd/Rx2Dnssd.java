...
public interface Rx2Dnssd {
    ...
    /**
     * Browse on a specific interface index (if_nametoindex).
     */
    @NonNull
    Flowable<BonjourService> browseOnInterface(
            @NonNull final String regType, @NonNull final String domain, int ifIndex);
